...
<head>
    ...
    <style>
        ...
        .outer-wrapper { background-color: #FDF4F9 !important; }
        .forced-white-bg { background-color: #FFFFFF !important; }
        .content-cell { padding: 10px 45px 40px 45px !important; }
        .label { font-weight: 700; color: #662237; }
        .info-box {
        ...
        .checklist-item { margin-bottom: 8px; font-size: 13px; color: #444444; }
                                ...
                                <tr>
                                    <td class="content-cell">
                                        ...
                                        <div style="margin-top: 30px; padding: 0 5px;">
                                            ...
                                            <div class="checklist-item">• Make sure to connect your laptop to a power source.</div>
                                        </div>
                                        <p style="font-size: 14px; line-height: 1.6; color: #444444; margin-top: 30px; margin-bottom: 15px;">
                                            <strong>Need Help?</strong> If you experience any technical issues at the time of joining, immediately refer to the FAQ document or contact us at <span style="color: #662237; font-weight: 600;">support@fabrichq.ai</span>. Do not wait - time lost due to technical delays will not be compensated.
                                        </p>
                                        <p style="font-size: 14px; line-height: 1.6; color: #444444; margin-bottom: 20px;">
                                            If you face technical difficulties, refer to the FAQ document immediately:
                                            <br>
